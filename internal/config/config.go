...
type Config struct {
	...
	// XAIKey defines native xAI API key configurations using the Codex key shape.
	...
	// gemini-api-key, codex-api-key, xai-api-key, claude-api-key, openai-compatibility, vertex-api-key, and ampcode.
...
type ClaudeKey struct {
	// Name is an optional human-readable label used by management and usage views.
...
// XAIKey uses the Codex API key structure for native xAI registration.
...
func LoadConfigOptional(configFile string, optional bool) (*Config, error) {
	...
	// Sanitize xAI keys using the same rules as Codex API keys.
	cfg.SanitizeXAIKeys()
